from yolact.data.configs.datasets import coco2014_dataset
...
config = {
    ...
    # Set this to a config object if you want an FPN (inherit from fpn_base). See helpers.fpn_base for details.
    'fpn': None,
